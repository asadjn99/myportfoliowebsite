  ...
  <div className="container mx-auto max-w-6xl relative z-10">
    ...
    <AnimatedSection delay={0.2}>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          {
            title: "Cricket Tournament Poster",
            img: "/images/poster1.jpg",
            desc: "Designed engaging poster for a cricket league event.",
          },
          {
            title: "Dental Offer Poster",
            img: "/images/poster2.jpg",
            desc: "Promotional Ramadan poster for a dental clinic.",
          },
        ].map((project, i) => (
          <div
            key={i}
            className="relative bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:-translate-y-1 transition-transform duration-300"
          >
            <div className="relative">
              ...
              />
              <p className="absolute bottom-2 right-3 text-xs font-bold text-white opacity-80">
                asadjn99
              </p>
            </div>
            <div className="p-4">
    ...
    {/* Company 2 Projects */}
    <AnimatedSection delay={0.3}>
      <h3 className="text-2xl font-semibold mt-16 mb-6 text-purple-600 dark:text-purple-400">
        Company-2 Projects
      </h3>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          {
            ...
            desc: "Promotional poster for a new product launch.",
          },
          {
            title: "Cultural Event Poster",
            img: "/images/poster4.jpg",
            desc: "Creative design for a university cultural festival.",
          },
        ].map((project, i) => (
          <div
            key={i}
    ...
    <AnimatedSection delay={0.4}>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          {
            title: "Pakhtunkhwa Tourism Hub",
            img: "/images/web1.jpg",
            desc: "Tourism platform showcasing destinations and hotels.",
            link: "https://your-tourism-site-link.com",
          },
          {
            title: "Responsive Bookstore",
            img: "/images/web2.jpg",
            desc: "Bootstrap-based online bookstore website.",
